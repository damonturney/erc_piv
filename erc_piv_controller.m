function [x,y,u,v,R_maxs]=erc_piv_controller(A,B,winsizes,winoverlaps,searchoverlaps,R_threshold,previous_u,previous_v,R_maxs,maske,sub_pixel,winsizethreshold)
...
for jj=jjs
    ...
    for ii=iis 
        ...
        if (length(maskimage_subwin(:))-sum(isnan(maskimage_subwin(:))))>winsizethreshold
